function write_flp( Option, NProf, rProf, Pos )

% Write a field-parameters file
% Revised by JakeJiangjn - 07/28/2014
% new input parameters NProf and rProf are added for a range dependent environment.
...
fprintf( fid, '%i   ! NProf \r\n', NProf );
fprintf( fid, '%8.2f  ', rProf );
fprintf( fid, '/  ! rProf (km) \r\n' );
